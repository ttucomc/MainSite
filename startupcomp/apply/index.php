    ...
    <!-- MAIN EDITS START -->
					...
					if ($_SERVER["REQUEST_METHOD"] == "POST") {
						...
						if ($resp->isSuccess()) {
							...
							$sql = "INSERT INTO student_startup (project_title, project_cat, team_member1, team_member2, team_member3, team_member4, team_member5, team_email, video_link)
								VALUES ('$projectTitle', '$projectCat', '$tMember1', '$tMember2', '$tMember3', '$tMember4', '$tMember5', '$teamEmail', '$videoLink')";
							...
							$message .= "<trstyle='background: #EEEEEE;'><td><strong>Team Contact Email:</strong></td><td>" . $teamEmail . "</td></tr>";
