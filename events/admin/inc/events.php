...
if(isset($_POST['form-name']) && $_POST['form-name'] == 'add-event') {
    add_event($_POST['add-event-name'], $_POST['add-event-description'], $_POST['add-event-location'], $_POST['add-event-address'], $_POST['add-event-date'], $_POST['add-event-time'], $_POST['add-event-password'], $_POST['add-rsvp-switch']);
    header('Location: ' . BASE_URL);
}

// If there was an event edited
if(isset($_POST['eventUpdated'])) {
    edit_event($_POST['eventUpdated'],$_POST['eventName'], $_POST['eventDescription'], $_POST['eventLocation'], $_POST['eventAddress'], $_POST['eventDate'], $_POST['eventTime'], $_POST['eventPassword']);
}
