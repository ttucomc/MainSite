...
<html class="no-js" lang="en">
  ...
  <section id="successRow">
    <div class="row">
      <div class="medium-6 columns">
        <?php echo "<a href=\"#\" class=\"successCard\">
          <img src=\"./images/mountains.svg\" alt=\"Mountains with Flags at the peaks\" class=\"bookIcon\">
          <p>Center for Student Success</p>
          <p>
            The Center for Success, Outreach &amp; Engagement provides students with the best resources to prepare for transitioning from college into their professional careers.<br>
            <br>
      ...
      <div class="medium-6 columns">
        <?php echo"<a href=\"#\" class=\"successCard\">
          <img src=\"./images/rocket.svg\" alt=\"A rocket ship\">
          <p>Career Center</p>
          <p>
            The Career Center, designed specifically for Media &amp; Communication students, is a resource for internship and job search assistance, career counseling, resume and portfolio development and other career related topics.<br>
            <br>
            <strong>Click here to find out more information!</strong>
          </p>
        </a>"; ?>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="medium-4 small-centered medium-uncentered columns">
        <a href="#" class="button">Scholarships</a>
      </div>
      <div class="medium-4 small-centered medium-uncentered columns">
        <a href="#" class="button">Study Abroad</a>
      </div>
    </div>
