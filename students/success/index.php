	    ...
	    <header class="header">
	        ...
	        <nav class="nav-wrapper-lower clearfix">
	            ...
	            <ul class="nav-primary-lower nav-inline clearfix">
					<li><a href="http://cmsdev.ttu.edu/comc/about/">About</a></li><!-- Required, no changes -->
					<li><a href="http://cmsdev.ttu.edu/comc/programs/">Programs &amp; Majors</a></li><!-- Required, no changes -->
					<li><a href="http://cmsdev.ttu.edu/comc/faculty/">Our People</a></li><!-- Required, no changes -->
					<li><a href="http://cmsdev.ttu.edu/comc/students/">Students</a></li><!-- Optional, can be removed, or changed with C&M review -->
					<li><a href="http://cmsdev.ttu.edu/comc/graduate/">Graduate Programs</a></li><!-- Optional, can be removed, or changed with C&M review -->
					<li><a href="http://cmsdev.ttu.edu/comc/alumni/">Alumni</a></li><!-- Optional, can be removed, or changed with C&M review -->
					<li><a href="http://cmsdev.ttu.edu/comc/research/">Research</a></li><!-- Optional, can be removed, or changed with C&M review -->
					<li><a href="http://cmsdev.ttu.edu/comc/contact/">Contact Us</a></li><!-- Required, no changes -->
				</ul>
	        </nav>
	    </header>
	</div>
        ...
        <div class="wrapper">
            <div class="wrapper">
                <ul class="breadcrumbs" style="display: none;">
                    ...
                    <li class="breadcrumbs-item"><a href="http://cmsdev.ttu.edu/comc">College of Media and Communications</a></li>
                </ul>
            </div>
            <div class="content-block">
               	<div class="columns-wrapper column-flex column-flexwrap audience-nav-placeholder-small">
                    <div class="column-full column-centered column-padded-horizontal">
                 	    <h1 class="header-large" style="display:none;">College of Media &amp; Communication</h1>
                  	</div>
  ...
  <br>
	...
	<seciton>
		...
		<div class="row">
			...
			<div class="medium-8 columns medium-offset-2 studentSuccess">

				<h1>Student Success</h1>

				<p>The College of Media &amp; Communication opened its Center for Success, Outreach  &amp; Engagement in October 2014 as a way to provide students with the best resources to prepare for transitioning from college into their professional careers.</p>
	...
	<!-- End Student Success Page title and description -->
  ...
  <br>
	...
	<section class="studentSuccessSection">
      ...
      <div class="row">
          ...
          <div class="large-6 columns">
            <div class="studentSuccessTextContainer">
              <h3 class="studentSuccessTextTitle">Scholarships</h3>
  ...
  <?php echo "<div><div><div><div>" ?>
    ...
    <div class="wrapper">
      <div class="columns-wrapper column-flex column-flexwrap">
        ...
        <div class='column-one-third column-centered column-padded-vertical-desktop'>
          <div class='fact fact-icon'>
            <a href='http://cmsdev.ttu.edu/comc/contact/index.php'><h3 class='fact-header fact-header-medium'><i class='icon-phone'></i></h3>
